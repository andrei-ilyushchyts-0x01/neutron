...
| `ioctl_family`    | string (optional)   | Family classification for `ioctl(2)` events: `"dma_heap"`, `"binder"`, `"dma_buf"`, `"binder_or_dma_buf"`, `"ashmem"`, `"kgsl"`, `"mali"`, `"alsa"`, `"lwis"`, `"gxp"`, `"trusty_tipc"`, `"v4l2"`, or `"unknown"`. The shared Binder/dma-buf magic remains explicitly ambiguous until FD path/kind evidence resolves it. |
