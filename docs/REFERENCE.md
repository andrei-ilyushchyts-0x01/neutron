...
| `ioctl_family`    | String (optional)   | `"dma_heap"`, `"binder"`, `"dma_buf"`, `"binder_or_dma_buf"` (1.5.0), `"ashmem"`, `"kgsl"`, `"mali"`, `"alsa"`, `"lwis"` (1.2.0), `"gxp"` (1.2.0), `"trusty_tipc"` (1.4.0), `"v4l2"` (1.4.0), or `"unknown"`. Emitted for `ioctl(2)` events; the shared Binder/dma-buf magic stays ambiguous without FD evidence. |
